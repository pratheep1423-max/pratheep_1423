  ...
  return (
    <section className="py-24 bg-studio-bg text-obsidian-900 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6 md:px-12 space-y-24">
        ...
        {/* Behind The Scenes Gallery - Clean Showcase (Editing done via Admin Sidebar) */}
        <div className="space-y-6 pt-12 border-t border-ivory-300">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              { id: 1, src: bts1, label: 'Photo 1' },
              { id: 2, src: bts2, label: 'Photo 2' },
              { id: 3, src: bts3, label: 'Photo 3' },
              { id: 4, src: bts4, label: 'Photo 4' }
            ].map((item) => (
              <div
                key={item.id}
